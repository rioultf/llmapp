...
* [Expérimenter la tokenisation](https://gpt-tokenizer.dev/)
[PCA sur les embeddings](https://projector.tensorflow.org/)
...
* [Expérimenter la proximité des mots](https://projector.tensorflow.org/)
...
* [Une mine](https://huggingface.co/spaces/hesamation/primer-llm-embedding)

...
## Références illustrées / interactives
...
* [Transformers + architecture + code + encodage positionnel](https://jaketae.github.io/study/transformer/)
* [Spécifique attention](https://jaketae.github.io/study/seq2seq-attention/)
* [Let's build GPT: from scratch, in code, spelled out.](<https://www.youtube.com/watch?v=kCc8FmEb1nY>)
    Les explications les plus précises que j'aies vues. Longue vidéo qui permet de faire en parallèle, pas à pas, avec des librairies standard.

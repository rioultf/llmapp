...
module.exports.runtime = {
    handler: async function ({ latitude, longitude }) {
      ...
      try {
        ...
        const averageTemperature = 10;//this._getAverage(data, "temperature_2m");
        const averageHumidity = 11;//this._getAverage(data, "relativehumidity_2m");
        const averageWindSpeed = 12;//this._getAverage(data, "windspeed_10m");

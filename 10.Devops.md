...
* [OpenWebUI](tp/6.OpenWebUi.md) : offre le meilleur contrôle sur l'exécution de modèles, avec tout un éco-système d'outils et de workflows. C'est réservé à des organisations importantes et assez hors de propos pour cette formation de technicien.

# Registres

* [LM Studio](tp/3.LMStudio.md)
